@{
    #Root module
    RootModule = 'NetQoSDSC.Helper.psm1'
    ...
    Description = 'Module with helper functions for the NetQoSDsc Resources.'
    ...
    PrivateData = @{
        ...
        PSData = @{
            ...
            Tags = @('DesiredStateConfiguration', 'DSC', 'DSCResourceKit', 'DSCResource','QoS')
